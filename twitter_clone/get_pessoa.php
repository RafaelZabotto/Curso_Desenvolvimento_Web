<?php
    ...
    $sql = "SELECT u.*, us.* FROM usuarios u LEFT JOIN usuarios_seguidores us ON us.id_usuario = '$id_usuario' AND u.id = us.seguindo_id_usuario WHERE u.usuario LIKE '%$nome_pessoa%' AND u.id <> '$id_usuario'"; 
